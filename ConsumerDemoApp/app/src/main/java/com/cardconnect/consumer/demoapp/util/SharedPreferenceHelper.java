package com.cardconnect.consumer.demoapp.util;

import android.content.Context;
import android.content.SharedPreferences;
import android.support.annotation.NonNull;

import com.cardconnect.consumer.demoapp.MainApp;
import com.cardconnect.consumer.demoapp.utils.GsonUtils;
...
public class SharedPreferenceHelper {
    ...
    private static SharedPreferences getSharedPreference() {
        return MainApp.get().getSharedPreferences(USER_LOCAL_SHARED_PREFERENCES, Context.MODE_PRIVATE);
    }
